...
import { Sparkles, X, CheckCircle2, ShieldCheck, FileText, Zap, UserCheck, ArrowRight } from 'lucide-react';
      ...
      >
        ...
        <div className="relative bg-gradient-to-r from-[#006A4E] via-[#00523d] to-[#0d3b2e] text-white p-6 sm:p-8 overflow-hidden shrink-0">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/15 backdrop-blur-md border border-white/25 rounded-full text-xs font-bold text-emerald-100 mb-3 shadow-xs">
            ...
            <span>MAJOR UPDATE RELEASE — V2.0</span>
          </div>

          <h2 className="text-2xl sm:text-3xl font-display font-extrabold text-white tracking-tight">
            What's New in IIUC Cover Platform
          </h2>
          <p className="text-emerald-100/90 text-xs sm:text-sm mt-1.5 font-medium max-w-lg">
            Welcome to the upgraded IIUC Academic Cover Page Generator & Student Portal.
          </p>
        </div>
        ...
        <div className="p-6 sm:p-8 overflow-y-auto space-y-4 font-sans text-slate-700 leading-relaxed text-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            ...
            {/* Feature 1 */}
            <div className="p-4 bg-emerald-50/50 border border-emerald-200/60 rounded-2xl flex items-start gap-3">
              <div className="p-2.5 bg-[#006A4E] text-white rounded-xl shrink-0 shadow-xs">
                <FileText className="h-4 w-4" />
              </div>
              <div>
                <h4 className="font-bold text-slate-900 text-xs sm:text-sm">Multi-Document Suite</h4>
                <p className="text-xs text-slate-600 mt-0.5">
                  Generate Assignments, Lab Reports, Lab Index records, and Project Covers with exact A4 print margins.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 bg-emerald-50/50 border border-emerald-200/60 rounded-2xl flex items-start gap-3">
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-xs sm:text-sm">IIUC Google Auth 2.0</h4>
                <p className="text-xs text-slate-600 mt-0.5">
                  Sign in with your official <span className="font-semibold text-[#006A4E]">@ugrad.iiuc.ac.bd</span> account to auto-fill student data.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 bg-emerald-50/50 border border-emerald-200/60 rounded-2xl flex items-start gap-3">
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-xs sm:text-sm">Faculty Auto-Suggest</h4>
                <p className="text-xs text-slate-600 mt-0.5">
                  Instant search across IIUC CSE & engineering faculty members and course catalogs.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 bg-emerald-50/50 border border-emerald-200/60 rounded-2xl flex items-start gap-3">
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-xs sm:text-sm">High-Res Vector Export</h4>
                <p className="text-xs text-slate-600 mt-0.5">
                  Instant 300 DPI Vector PDF and crisp JPG exports ready for submission & printing.
                </p>
              </div>
            </div>
          ...
          <div className="p-4 bg-slate-50 border border-slate-200/80 rounded-2xl space-y-2">
            <h5 className="font-bold text-xs text-slate-900 uppercase tracking-wider">System Improvements</h5>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-slate-700">
              ...
              <li className="flex items-center gap-2">
                <CheckCircle2 className="h-3.5 w-3.5 text-[#006A4E] shrink-0" />
                <span>Saved History & Cloud Drafts</span>
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="h-3.5 w-3.5 text-[#006A4E] shrink-0" />
                <span>Centralized Admin Analytics</span>
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle2 className="h-3.5 w-3.5 text-[#006A4E] shrink-0" />
        ...
        <div className="p-5 bg-slate-50 border-t border-slate-200/80 flex flex-col sm:flex-row items-center justify-between gap-4 shrink-0">
          ...
          <button
            onClick={handleGotIt}
            className="w-full sm:w-auto px-6 py-2.5 bg-[#006A4E] hover:bg-[#00523d] text-white text-xs sm:text-sm font-bold rounded-xl shadow-md transition-all flex items-center justify-center gap-2 active:scale-95"
          >
